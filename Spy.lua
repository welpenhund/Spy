			...
			if player ~= nil and (not Spy.InInstance or zone == GetZoneText()) then
				if not Spy.PlayerCommList[player] then
					...
					if strlen(race) > 0 then
						...
						if (Spy.EnemyFactionName == "Alliance" and race ~= "Draenei" and race ~= "Dwarf" and race ~= "Gnome" and race ~= "Human" and race ~= "Night Elf")
						or (Spy.EnemyFactionName == "Horde" and race ~= "Blood Elf" and race ~= "Orc" and race ~= "Tauren" and race ~= "Troll" and race ~= "Undead") then
							return
						end
					else
						race = nil
